  ...
  create(context) {
    ...
    return {
      ...
      VariableDeclaration(node) {
        ...
        const isObjectDestructure = conforms(
          type.isIdentifier(assignedExpression),
          type.isObjectPattern(declarator.id),
        );
        ...
        } else if (isObjectDestructure && hasMinProperties(declarator.id)) {
          shouldThrow = !arePropsOnePerLine(declarator.id);
